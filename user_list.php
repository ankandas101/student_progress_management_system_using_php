...
<div class="col-lg-12">
	<div class="card card-outline card-success">
		<div class="card-header">
			...
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="export.php" target="_blank"><i class="fa fa-plus"></i> Export</a>
			</div>
		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM students order by s_id asc");
