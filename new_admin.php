			...
			<form action="" id="manage_admin">
				...
				<div class="row">
					...
					<div class="form-group">
							...
							<input type="number" class="form-control form-control-sm" name="user_id" placeholder="......" required value="<?php echo isset($user_id) ? $user_id : '' ?>">
						</div>
						<div class="form-group">
...
<script>
	...
	$('#manage_admin').submit(function(e){
		e.preventDefault()
